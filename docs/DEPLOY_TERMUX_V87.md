# أمر الرفع من Termux — v8.7

> استخدم هذا الأمر إذا كان الملف المضغوط في مجلد Download باسم `v87.zip`.
...
git add .
git commit -m "Release v8.7 deploy readiness and build safety"
git branch -M main
